    ...
    <div>
      <div>
        <div className="flex mt-6 justify-center items-center ">
          <button
            onClick={openModal}
            className="bg-[#2194FF] border border-[#959595] rounded-lg hover:bg-blue-400 hover:text-white text-white font-bold py-3 px-6 flex items-center"
          >
            <RiAddLine className="inline-block text-white   mr-1 text-xl" />
            Add Delegates
          </button>
        </div>
