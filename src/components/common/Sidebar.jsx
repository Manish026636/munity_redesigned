...
const Sidebar = () => {
  ...
  <nav className="flex-1 pt-10 space-y-4 w-full px-6">
    <button className="block py-3 w-full border border-blue-500 rounded-lg font-bold text-lg bg-[#2194FF] hover:text-white hover:border-white hover:bg-blue-600 text-white">
      Roll Call
    </button>
    <button className="block py-3 w-full border border-blue-500 rounded-lg font-bold text-lg bg-white hover:text-white text-gray-700 hover:border-white hover:bg-blue-600">
      GSL
    </button>
    <button className="block py-3 w-full border border-blue-500 rounded-lg font-bold text-lg bg-white hover:text-white text-gray-700 hover:border-white hover:bg-blue-600">
      Mod-Cocus
