...
const GSLTime = () => {
  return (
    <div>
        <div className="bg-gray-600 mt-1 h-20 border-t-8 border-[#74C5FF] rounded-md w-5/6">
        <h2 className="text-3xl text-center text-white font-bold py-4 mb-1">
          Timer
        </h2>
      </div>
      <div className=" grid grid-cols-1  justify-center w-5/6 h-[28vh] border-4 border-[#ABABAB] mt-1 rounded-md">
        <div className="">
